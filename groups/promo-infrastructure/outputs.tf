  ...
  data_json = <<EOT
{
  ...
  "s3_promo_web_hosting_logs_bucket-id": "${module.s3_promo_web_hosting_logs_bucket.s3_bucket_id}",
  "s3_promo_web_hosting_logs_bucket-arn": "${module.s3_promo_web_hosting_logs_bucket.s3_bucket_arn}",
  "s3_promo_web_hosting_logs_bucket-name": "${local.s3_promo_web_hosting_logs_bucket}"
}
EOT
}
